...
$(document).ready(function(){
	...
	var weatherURL = 'http://api.openweathermap.org/data/2.5/weather?q={Atlanta}&units=Imperial&APPID=' + apiKey;
	 ...
	 $('#user-search').submit(function(event){
			...
			var searchURL = 'http://api.openweathermap.org/data/2.5/weather?q={' +userSearch + '},{us}&units=Imperial&appid=' + apiKey;
		...
		//weatherData.main.temp
			...
			var currConditions = weatherData.weather[0].icon;
				console.log(currConditions);
		//console.log(currTemp);
				var newHTML = ' ';
				newHTML = '<img id="weather-image" src="http://openweathermap.org/img/w/' + currConditions + '.png"></img>';

				$('#weather-icon').html(newHTML);
		//console.log(currTemp);
